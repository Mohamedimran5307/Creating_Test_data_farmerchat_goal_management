...
    When the user sends a POST request to "Create_new_Conversation" with header as "Authorization"
    Then the API call got success with status code 200
    And "message" in response body is "Successfully created new conversation"
